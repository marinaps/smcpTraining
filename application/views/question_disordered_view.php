  ...
  ?>
    ...
    <div class="containermenu">
        <ol class="breadcrumb">
          ...
          <li class="active">Jumbled phrases</li>
        </ol>
    </div>

    <h3><center>Jumbled phrases Data</center></h3>
    ...
    <div class="containermenu">
        ...
        <button class="btn btn-default" onclick="location.href='<?php echo site_url();?>upload/upload_disordered'"><i class="glyphicon glyphicon-upload"></i> Upload file</button>
        <br />
        <br />
...
$(document).ready(function() 
{
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('disorderedquestion/ajax_list')?>",
            "type": "POST"
        },
...
function edit_question(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('disorderedquestion/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="ordered"]').val(data[0]['ordered']);
            $('[name="disordered"]').val(data[0]['disordered']);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('disorderedquestion/ajax_add')?>";
    } else {
        url = "<?php echo site_url('disorderedquestion/ajax_update')?>";
    }
...
function delete_question(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('disorderedquestion/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                      ...
                      <span class="help-block"></span>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Ordered</label>
                            <div class="col-md-9">
                                <input name="ordered" placeholder="question" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="control-label col-md-3">Disordered</label>
                            <div class="col-md-9">
                                <input name="disordered" placeholder="answer" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
