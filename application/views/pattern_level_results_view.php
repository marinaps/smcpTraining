   ...
   <div class="section">
      <div class="containermenu">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Training Results Pattern Level</li>
        </ol>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('result/ajax_list_pattern')?>",
                "type": "POST"
            },
    ...
    function see_results(id)
    {
       ...
       window.location.href = "<?php echo site_url();?>result/display_pattern_results/"+id;
    }
